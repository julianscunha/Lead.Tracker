...
class OpenRouterProvider(HTTPChatProvider, AIProvider):
    ...
    async def test_connection(self) -> ConnectionTestResult:
        try:
            ...
            return ConnectionTestResult.ok("openrouter acessível")
        except Exception as exc:  # noqa: BLE001 — vira mensagem amigável, nunca stack técnico
