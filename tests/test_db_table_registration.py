...
def test_init_db_creates_tables_even_without_explicit_db_models_import():
    ...
    # 12 tabelas: vendors, products, services, companies, contacts, opportunities,
    ...
    # rep_targets (Fase D módulo 7).
    assert table_count == 12, f"esperava 12 tabelas, criou {table_count} — regressão do bug de metadata vazio"
