...
def test_init_db_creates_tables_even_without_explicit_db_models_import():
    ...
    # 13 tabelas: vendors, products, services, companies, contacts, opportunities,
    ...
    assert table_count == 13, f"esperava 13 tabelas, criou {table_count} — regressão do bug de metadata vazio"
